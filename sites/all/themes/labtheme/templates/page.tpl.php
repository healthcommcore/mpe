...
<div class="navbar-header">
    ...
    <!--
      ...
      <span class="icon-bar"></span>
    -->
      <span class="menu-text-xs">Menu</span>
    </button>
</div>
...
<?php endif; ?>
<?php
  $main_container_margin = $is_front ? "" : "main-container-margin";
  $left_col = "";
  if ($is_front) {
    $left_col = "col-lg-6 col-lg-push-1 col-sm-7";
  }
  else if ( isset($node) && !in_array($node->nid, $subpages) ) {
    $left_col = "col-md-3 hidden-sm";
    $content_column_class = " class='col-md-9 col-sm-12'";
  }
  else {
    $left_col = "col-sm-3 hidden-xs";
  }
?>
<div class="main-container content-area-color">
  <div class="container">
    <div class="row">
    <div class="<?php echo $main_container_margin; ?>">
    <?php if (!empty($page['left_column'])): ?>
    <aside class="<?php echo $left_col; ?>" role="complementary">
        <?php print render($page['left_column']); ?>
      </aside>  <!-- /#sidebar-first -->
    <?php endif; ?>
    <?php if ( $is_front && !empty($page['right_column']) ) : ?>
      <aside class="col-lg-4 col-lg-push-1 col-sm-5" role="complementary">
